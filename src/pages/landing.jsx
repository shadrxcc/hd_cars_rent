...
gsap.fromTo(
  ...
  return (
    <>
      ...
      <div ref={landingRef} className="landing-page pointer-events-none bg-red-700 w-full h-full flex flex-column justify-center items-center gap-y-2 absolute top-0 left-0">
        <div className="name-container">
          <div ref={logoRef} className="logo-name tracking-[16px] text-bold text-white text-2xl ml-3 text-center">
            HDCARS
          </div>
        </div>
      </div>
