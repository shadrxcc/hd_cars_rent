...
function Specscard() {
  return (
    <div className="mx-auto row justify-center flex md:inline-flex">
      <div className="spec-card m-2 col-md-2 col-lg-2" data-aos="fade-up" data-aos-duration="1500">
...
<div className="circle-wrap ">
      ...
      <div className="spec-card m-2 col-md-2 col-lg-2" data-aos="fade-up-left" data-aos-duration="1000">
...
<div className="circle-wrap ">
      ...
      <div className="spec-card m-2 col-md-2 col-lg-2" data-aos="fade-up-right" data-aos-duration="1000">
<div className="circle-wrap ">
          <div className="circle">
            <div className="mask full-1">
              <div className="fill-1"></div>
      ...
      <div className="spec-card m-2 col-md-2 col-lg-2" data-aos="fade-up" data-aos-duration="1000">
<div className="circle-wrap ">
          <div className="circle">
            <div className="mask full-1">
              <div className="fill-1"></div>
